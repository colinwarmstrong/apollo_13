...
describe 'user visits /astronauts' do
  ...
  it 'user sees the average age of all astronuats' do
    astronuat_1 = Astronaut.create(name: 'Neil Armstrong', age: 10, job: 'Commander')
    astronaut_2 = Astronaut.create(name: 'Buzz Aldrin', age: 20, job: 'Pilot')
    astronaut_2 = Astronaut.create(name: 'Joe Johnson', age: 30, job: 'Janitor')
